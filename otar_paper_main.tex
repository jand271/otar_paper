...
We note that modern commodity electrons perform these operations often and often include hardware-specific acceleration in their chips to increase computational efficiency and allow parallelism.
Therefore, we expect that if these methods burden current receivers, receivers manufacturers could augment those chip improvements at a minimal cost.
