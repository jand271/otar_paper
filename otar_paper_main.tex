...
Upon startup after a shutdown less than the Hash Path End Cryptoperiod, (1) receivers not need to await delivery of an updated Authentication Stack via MT51, and (2) receivers will have to accommodate a more intense preliminary hashing operation at startup to hash the current MT50 Hash Point to the authenticated Hash Path End.
