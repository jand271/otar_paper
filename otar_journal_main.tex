...
\section{SBAS Authentication Scheme Definition} \label{sec:sbas_authentication_scheme_definition}
	...
	\subsection{MT51} \label{sub:mt51}
		...
		The difference between MT51-A and MT51-B is the amount of bits devoted to (1) the OTAR Payload Segment and (2) meta-data describing how to interpret the OTAR Payload Segment of a particular MT51.
		...
		\begin{table}%\label{tab: mt51-a}
				...
				\multicolumn{5}{|c|}{MT51-A Bit Allocation} \\ \hline
					Preamble & MT & Segment Number & OTAR Segment & CRC \\ \hline
					4 & 6 & 5 & 211 & 24 \\ \hline
				\end{tabular}
				\caption{
		...
		\begin{table}%\label{tab: mt51-b}
			...
			\begin{tabular}{|c|c|c|c|c|} \hline
				...
				Preamble & MT & Payload Metadata & OTAR Payload Segment & CRC \\ \hline
				4 & 6 & 88 & 128 & 24 \\ \hline
			\end{tabular}
			\caption{
		...
		For MT51-A, the total OTAR payload Segment, see Table~\ref{tab: psuedorandom lengths}, is divided into ten 211-bit chunks forming ten unique MT51s that must be broadcast repeatedly.
...
\section{OTAR Design Methodology} \label{sec:otar_design_methodology}
	...
	\subsection{MT51-A/B Balance} \label{sec: MT51 balance}
		...
		Therefore, we offer a couple of suggests on how to reason about balancing the design while maintaining the schemes modularity, simplicity, and flexibility.
