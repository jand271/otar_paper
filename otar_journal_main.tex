...
\section{Introduction} \label{sec:introduction}
	...
	In this work, we call the authenticating data ``signatures'', and signatures, together with the associated key data, either ``authenticating ciphertext'' or ``OTAR Payload'', referring to the pseudorandom data or the chunks separated for transmission to receiver, respectively.
...
\section{SBAS Authentication Scheme Definition} \label{sec:sbas_authentication_scheme_definition}
	...
	\subsection{Procedures} \label{sub:procedures}
		...
		\begin{algorithm}%\label{alg: TESLA receiver}
			...
			\While{on}{
				Receive MT51-B payload pages associated via the MT51-B metadata and store into three hash tables $H_1$, $H_2$, and $H_3$. 
				...
				Await receipt of all needed unique MT51-B pages, called the Authentication Stack, to assert authenticated Hash Path Ends.
			...
			\While{on}{
				...
				\If{$m_7 \cdots m_{11}$ are MT51}{
					Follow the MT51-B procedures above\;
				}
